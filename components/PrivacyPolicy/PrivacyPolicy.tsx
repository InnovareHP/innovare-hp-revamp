      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-12 py-20 flex flex-col lg:flex-row gap-16">
        ...
        <article className="flex-1 space-y-24 max-w-3xl">
          ...
          <motion.section
            ...
            transition={transitionBase}
          >
            <h2 className="text-3xl font-bold mb-8 tracking-tight">Log Data</h2>
            <p className="text-slate-600 leading-relaxed">
              ...
              spent on pages. This helps us improve functionality and security.
            </p>
          </motion.section>
          ...
          <motion.section
            ...
            transition={transitionBase}
          >
            <h2 className="text-3xl font-bold mb-8 tracking-tight">Cookies</h2>
            <p className="text-slate-600 mb-6">
              We use cookies to understand site traffic, improve content, and
              optimize marketing efforts.
            </p>
            <p className="text-slate-600 text-sm italic">
              You may refuse cookies via browser settings, though some features
              may be affected.
            </p>
          </motion.section>
          ...
          <motion.section
            ...
            transition={transitionBase}
          >
            <h2 className="text-3xl font-bold mb-8 tracking-tight">Security</h2>
