...
const Navigation = ({ isFieldNotes = false }: NavigationProps) => {
  ...
  return (
    <header className={`fixed top-0 left-0 w-full z-50 px-6 py-2 md:p-10 pointer-events-none transition-colors duration-300 ${isScrolled ? "bg-white" : "bg-transparent"}`}>
